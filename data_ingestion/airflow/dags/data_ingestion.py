...
dataset_url = f"https://d37ci6vzurychx.cloudfront.net/trip-data/{dataset_file}"#f"https://s3.amazonaws.com/nyc-tlc/trip+data/{dataset_file}"
...
def download_zones_parquetize_upload_dag(
    dag,
    url_template,
...
download_zones_parquetize_upload_dag(
    dag=zones_data_dag,
